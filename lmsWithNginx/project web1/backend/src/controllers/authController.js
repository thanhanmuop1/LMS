...
const register = async (req, res) => {
    try {
        ...
        // Kiểm tra và lấy school_id an toàn hơn
        const school_id = req.school?.id || null; // Nếu không có req.school thì school_id = null
        ...
        const user = await auth.createUser({
            ...
            school_id  // Có thể null cho domain chính
        });
...
const login = async (req, res) => {
    try {
        ...
        if (!user || user.school_id !== req.school.id) {
