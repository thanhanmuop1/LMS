...
// Course routes
router.get('/courses', subdomainMiddleware, teacherController.getTeacherCourses);
...
// Document routes
router.get('/courses/:courseId/documents', [authMiddleware, isTeacher, subdomainMiddleware], teacherController.getCourseDocuments);
