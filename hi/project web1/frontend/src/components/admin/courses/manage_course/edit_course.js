...
import { Modal, Form, Input, Upload, message, Switch, Button } from 'antd';
...
const EditCourse = ({ visible, onCancel, onSuccess, courseData }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      await axiosConfig.put(`/courses/${courseData.id}`, {
        ...values,
        thumbnail: imageUrl,
  ...
  return (
    ...
    >
      ...
      <Button type="link" onClick={() => navigate(`/course/${courseData.id}/description`)}>Xem mô tả chi tiết</Button>
    </Modal>
  );
};
