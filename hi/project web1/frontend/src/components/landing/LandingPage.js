...
import {RocketOutlined, BookOutlined, LineChartOutlined, TeamOutlined, CloudOutlined, SafetyCertificateOutlined, MenuOutlined, CheckOutlined, CloseOutlined, UpOutlined, CaretDownOutlined} from '@ant-design/icons';
  ...
  const renderAuthButtons = () => {
        ...
        <div className="user-menu" ref={menuRef}>
            ...
            <div className="user-avatar">
              {userData?.avatar ? (
                ...
                <div className="avatar-placeholder">
                  {userData?.full_name?.[0] || userData?.username?.[0] || 'U'}
                </div>
              )}
            </div>
          ...
          {showUserMenu && (
            <div className="dropdown-menu">
              ...
              <Link to="/admin/schools" className="menu-item">
                Quản lý
              </Link>
    ...
    return (
      <div className="auth-buttons">
        <Button type="text" className="login-button" onClick={() => navigate('/login')}>
          Đăng nhập
        </Button>
          ...
          {userData ? (
            <div className="mobile-user-menu">
              <div className="user-info">
                <div className="user-avatar">
                  {userData?.avatar ? (
                    <img src={getImageUrl(userData.avatar)} alt="Avatar" />
                  ) : (
                    <div className="avatar-placeholder">
                      {userData?.full_name?.[0] || userData?.username?.[0] || 'U'}
                    </div>
              ...
              <Menu mode="vertical">
                ...
                <Menu.Item key="courses" onClick={() => navigate('/enrolled-courses')}>
                  Khóa học của tôi
                </Menu.Item>
