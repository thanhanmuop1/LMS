      ...
      <div className="content-section">
        <Card className="quiz-intro-card">
          ...
          <div className="quiz-info">
            <Alert
              message={quiz.test ? "Thông tin bài thi" : "Thông tin bài kiểm tra"}
              description={
                <Space direction="vertical">
                  ...
                  {quiz.test && (
                    <Text type="warning">
                      <strong>Lưu ý:</strong> Đây là bài thi chính thức. Bạn sẽ không thể xem lại đáp án hoặc làm lại.
                    </Text>
                  )}
                </Space>
              }
    ...
    return (
      <div className="content-section">
        <Card className="quiz-card">
          ...
          {!quiz.test && showAnswers && <QuizReview quiz={quiz} quizResult={quizResult} />}
        </Card>
      </div>
    );
  }
