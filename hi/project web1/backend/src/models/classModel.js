...
const classModel = {
    getTeacherClasses: (teacherId, schoolId) => {
        return new Promise((resolve, reject) => {
            ...
            `;
            db.query(sql, [teacherId, schoolId], (error, results) => {
                if (error) {
                    reject(error);
                    return;
                }
    ...
    getClassById: (classId, teacherId, schoolId) => {
        return new Promise((resolve, reject) => {
            const sql = 'SELECT * FROM classes WHERE id = ? AND teacher_id = ? AND school_id = ?';
            db.query(sql, [classId, teacherId, schoolId], (error, results) => {
                if (error) {
                    reject(error);
                    return;
                }
    ...
    getEnrolledClasses: (studentId, schoolId) => {
        return new Promise((resolve, reject) => {
            const sql = `
                SELECT 
                    c.*,
            ...
            db.query(sql, [studentId, schoolId], (error, results) => {
                if (error) {
                    reject(error);
                    return;
                }
