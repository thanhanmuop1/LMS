...
// router.get('/videos/:videoId/quizzes', [authMiddleware.authMiddleware, subdomainMiddleware], quizController.getQuizzesForVideo);
...
router.get('/quizzes', subdomainMiddleware, quizController.getAllQuizzes);
...
router.post('/quizzes', [authMiddleware.authMiddleware, subdomainMiddleware], quizController.createQuiz);
...
router.delete('/quizzes/:quizId', authMiddleware.authMiddleware, quizController.deleteQuizzes);
