...
// Thêm route để cập nhật mô tả
router.get('/courses/:courseId/description', lmsControllers.getCourseDescription);
router.put('/courses/:courseId/description', authMiddleware, lmsControllers.updateCourseDescription);

// Thêm route để lấy đánh giá khóa học
router.get('/courses/:courseId/rating', lmsControllers.getCourseRating);
router.post('/courses/:courseId/rating', authMiddleware, lmsControllers.createCourseRating);
router.get('/courses/:courseId/rating-stats', lmsControllers.getCourseRatingStats);
